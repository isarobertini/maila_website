...
// node_modules/@dotlottie/player-component/dist/dotlottie-audio-75C54RUV.mjs
var L = u((x) => {
  (function() {
    var g = function() {
      this.init();
      ...
      if (!(e._audioUnlocked || !e.ctx)) {
        ...
        var n = function(t) {
          ...
          m.buffer = e._scratchBuffer, m.connect(e.ctx.destination), typeof m.start > "u" ? m.noteOn(0) : m.start(0), typeof e.ctx.resume == "function" && e.ctx.resume(), m.onended = function() {
            ...
            for (var v2 = 0; v2 < e._howls.length; v2++) e._howls[v2]._emit("unlock");
          };
        };
    ...
    u2.prototype = { init: function(e) {
      ...
      for (var t = n._getSoundIds(e), r = 0; r < t.length; r++) {
        ...
        if (s && !s._paused && (s._seek = n.seek(t[r]), s._rateSeek = 0, s._paused = true, n._stopFade(t[r]), s._node)) if (n._webAudio) {
      ...
      if (typeof n > "u") if (typeof e == "boolean") t._muted = e;
      ...
      var s = this;
      if (s._state !== "loaded" || s._playLock) return s._queue.push({ event: "fade", action: function() {
        s.fade(e, n, t, r);
      } }), s;
      ...
      if (n.length === 1) if (typeof n[0] == "boolean") t = n[0], e._loop = t;
      else return s = e._soundById(parseInt(n[0], 10)), s ? s._loop : false;
      else n.length === 2 && (t = n[0], r = parseInt(n[1], 10));
      for (var d = e._getSoundIds(r), a = 0; a < d.length; a++) s = e._soundById(d[a]), s && (s._loop = t, e._webAudio && s._node && s._node.bufferSource && (s._node.bufferSource.loop = t, t && (s._node.bufferSource.loopStart = s._start || 0, s._node.bufferSource.loopEnd = s._stop, e.playing(d[a]) && (e.pause(d[a], true), e.play(d[a], true)))));
      return e;
    }, rate: function() {
      var e = this, n = arguments, t, r;
      ...
      if (typeof t == "number" && (e._state !== "loaded" || e._playLock)) return e._queue.push({ event: "seek", action: function() {
        e.seek.apply(e, n);
      } }), e;
      ...
      for (var r = 0; r < n._sounds.length; r++) if (!n._sounds[r]._paused) return true;
      return false;
    }, duration: function(e) {
    ...
    HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(o) {
      var u2 = this;
      if (!u2.ctx || !u2.ctx.listener) return u2;
      for (var i = u2._howls.length - 1; i >= 0; i--) u2._howls[i].stereo(o);
      return u2;
    }, HowlerGlobal.prototype.pos = function(o, u2, i) {
      var p = this;
      if (!p.ctx || !p.ctx.listener) return p;
      if (u2 = typeof u2 != "number" ? p._pos[1] : u2, i = typeof i != "number" ? p._pos[2] : i, typeof o == "number") p._pos = [o, u2, i], typeof p.ctx.listener.positionX < "u" ? (p.ctx.listener.positionX.setTargetAtTime(p._pos[0], Howler.ctx.currentTime, 0.1), p.ctx.listener.positionY.setTargetAtTime(p._pos[1], Howler.ctx.currentTime, 0.1), p.ctx.listener.positionZ.setTargetAtTime(p._pos[2], Howler.ctx.currentTime, 0.1)) : p.ctx.listener.setPosition(p._pos[0], p._pos[1], p._pos[2]);
      else return p._pos;
      return p;
      ...
      if (typeof u2 > "u") if (typeof o == "number") i._stereo = o, i._pos = [o, 0, 0];
...
@dotlottie/player-component/dist/dotlottie-audio-75C54RUV.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=dotlottie-audio-75C54RUV-SAWU2VHC.js.map
