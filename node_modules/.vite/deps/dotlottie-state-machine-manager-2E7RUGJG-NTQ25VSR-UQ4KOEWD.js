import {
  ...
  q,
  rn
} from "./chunk-ZJHJS5YT.js";
import "./chunk-NZUJJKRK.js";
import {
  __publicField
} from "./chunk-2TUXWMP5.js";

// node_modules/@dotlottie/player-component/dist/dotlottie-state-machine-manager-2E7RUGJG-NTQ25VSR.mjs
var p = function() {
...
function fe(e, t) {
  return ct(e.states, function(n, i) {
    if (n) {
      ...
      if (r) return { current: r, states: fe(n, r) };
    }
  });
}
function De(e, t) {
  return { current: t, states: fe(e, t) };
}
function ne(e, t, n, i) {
  var r = e && n.reduce(function(o, a) {
    var s, c, u = a.assignment, h = { state: i, action: a, _event: t }, f = {};
...
function de(e, t) {
  if (e) return A(e) ? { type: Rt, name: e, predicate: t ? t[e] : void 0 } : T(e) ? { type: Rt, name: e.name, predicate: e } : e;
}
function ze(e) {
  try {
...
function Lt(e, t) {
  return A(e) || typeof e == "number" ? p({ type: e }, t) : e;
}
function R(e, t) {
  if (!A(e) && "$$type" in e && e.$$type === "scxml") return e;
  var n = Lt(e);
  return p({ name: n.type, data: n, $$type: "scxml", type: "external" }, t);
}
function Z(e, t) {
  var n = le(t).map(function(i) {
    return typeof i > "u" || typeof i == "string" || rt(i) ? { target: i, event: e } : p(p({}, i), { event: e });
  });
  return n;
}
function Je(e) {
...
function dt(e, t) {
  ...
  } else if (T(e)) n = { type: e.name || e.toString(), exec: e };
  else {
    var i = Jt(e.type, t);
    if (T(i)) n = p(p({}, e), { exec: i });
    else if (i) {
      var r = i.type || e.type;
      n = p(p(p({}, i), e), { type: r });
    } else n = e;
...
function Qt(e) {
  var t = dt(e);
  return p(p({ id: A(e) ? e : t.id }, t), { type: t.type });
}
function qe(e, t) {
...
function Ue(e, t, n, i) {
  ...
  return p(p({}, e), { type: pt, _event: o, delay: a });
}
function $e(e, t) {
...
function Fe(e, t, n, i) {
  ...
  return p(p({}, e), { to: c, _event: o, event: o.data, delay: a });
}
var Xe = function(e, t, n) {
  return p(p({}, e), { value: A(e.expr) ? e.expr : e.expr(t, n.data, { _event: n }) });
};
var Qe = function(e) {
...
function jt(e, t, n, i, r, o, a) {
  a === void 0 && (a = false);
  var s = a ? [] : Ye(r), c = s.length ? ne(n, i, s, t) : n, u = a ? [n] : void 0, h = [];
  function f(y, v) {
    var _;
    switch (v.type) {
      case pt: {
        var g2 = Ue(v, c, i, e.options.delays);
        return o && typeof g2.delay == "number" && o(g2, c, i), g2;
      }
      case Pt:
      ...
      case ae: {
        c = ne(c, i, [v], o ? void 0 : t), u == null || u.push(c);
        break;
      }
      default:
        ...
        if (o) o(j, c, i);
          ...
          var B = u.length - 1, at = p(p({}, j), { exec: function(yt) {
            for (var $ = [], H = 1; H < arguments.length; H++) $[H - 1] = arguments[H];
            z.apply(void 0, V([u[B]], O($), false));
          } });
          j = at;
        }
        return j;
...
function ht(e, t) {
  ...
  try {
    for (var m = E(l), b = m.next(); !b.done; b = m.next()) {
      var v = b.value;
      if (v.type === "compound" && (!g2.get(v) || !g2.get(v).length)) f.get(v) ? f.get(v).forEach(function(M) {
        return l.add(M);
...
function cn(e, t) {
  var n = e.exec, i = p(p({}, e), { exec: n !== void 0 ? function() {
...
var F = function() {
  ...
  return e.from = function(t, n) {
    if (t instanceof e) return t.context !== n ? new e({ value: t.value, context: n, _event: t._event, _sessionid: null, historyValue: t.historyValue, history: t.history, actions: [], activities: t.activities, meta: {}, events: [], configuration: [], transitions: [], children: {} }) : t;
    var i = nt;
    ...
    return p(p({}, i), { tags: Array.from(n) });
...
var re = function() {
  function e(t) {
    this.processingEvent = false, this.queue = [], this.initialized = false, this.options = p(p({}, un), t);
  }
...
function dn(e, t) {
  ...
  }, s = nn({ id: t.id, send: function(u) {
    r.push(u), a();
  }, getSnapshot: function() {
    return n;
  }, subscribe: function(u, h, f) {
    var l = Et(u, h, f);
    return i.add(l), l.next(n), { unsubscribe: function() {
      i.delete(l);
    } };
...
Event: `).concat(JSON.stringify(l.data)));
      ...
      if ("machine" in y) {
        if (i.status !== D.Stopped || i.parent !== y || i.state.done) {
          var v = p(p({}, h), { name: h.name === Te ? "".concat(ut(i.id)) : h.name, origin: i.sessionId });
      ...
      if (v) try {
        return v(f, l.data, i.machine.config.predictableActionArguments ? { action: h, _event: l } : { action: h, state: i.state, _event: l });
      } catch (B) {
      ...
      switch (h.type) {
        ...
        case Pt:
          var g2 = h;
          if (typeof g2.delay == "number") {
            i.defer(g2);
            return;
          } else g2.to ? i.sendTo(g2._event, g2.to, l === nt) : i.send(g2._event);
          break;
        case oe:
          i.cancel(h.sendId);
          break;
        case Mt: {
          ...
          if (m.type === P.Invoke) {
            ...
            var w = T(S) ? S(f, l.data, { data: L, src: b, meta: m.meta }) : S;
            if (!w) return;
            var M = void 0;
    ...
    this.id = u, this.logger = a, this.clock = o, this.parent = s, this.options = r, this.scheduler = new re({ deferEvents: this.options.deferEvents }), this.sessionId = st.bookId();
  }
  return Object.defineProperty(e.prototype, "initialState", { get: function() {
    ...
    try {
      for (var _ = E(this.listeners), g2 = _.next(); !g2.done; g2 = _.next()) {
        var v = g2.value;
        v(t, t.event);
      }
    } catch (w) {
      ...
      try {
        g2 && !g2.done && (a = _.return) && a.call(_);
      } finally {
        if (o) throw o.error;
      }
    }
    ...
    try {
      for (var _ = E(this.contextListeners), g2 = _.next(); !g2.done; g2 = _.next()) {
        var d = g2.value;
    ...
    return this._stop(), n.schedule(function() {
      var i = R({ type: "xstate.stop" }), r = tt(t, function() {
        var o = I(V([], O(t.state.configuration), false).sort(function(h, f) {
    ...
    if (t.length) {
      ...
      this.scheduler.schedule(function() {
        var r, o, a = n.state, s = false, c = [], u = function(d) {
          var y = R(d);
    ...
    if (rt(t)) return this.spawnMachine(t, p(p({}, i), { id: n }));
    ...
    var i = this;
    n === void 0 && (n = {});
    var r = new e(t, p(p({}, this.options), { parent: this, id: n.id || t.id })), o = p(p({}, vn), n);
    ...
    var i, r = this, o = false, a = /* @__PURE__ */ new Set(), s = /* @__PURE__ */ new Set(), c, u = function(l) {
      c = l, s.forEach(function(d) {
        return d(l);
      }), !o && r.send(R(l, { origin: n }));
    }, h;
    try {
      h = t(u, function(l) {
        a.add(l);
    ...
    var f = (i = { id: n, send: function(l) {
      return a.forEach(function(d) {
        return d(l);
      });
    }, subscribe: function(l) {
      var d = Et(l);
      return s.add(d.next), { unsubscribe: function() {
        s.delete(d.next);
      } };
    }, stop: function() {
      o = true, T(h) && h();
    ...
    if (this.options.devTools && t) {
      if (t.__REDUX_DEVTOOLS_EXTENSION__) {
        ...
        this.devTools = t.__REDUX_DEVTOOLS_EXTENSION__.connect(p(p({ name: this.id, autoPause: true, stateSanitizer: function(i) {
          return { value: i.value, context: i.context, actions: i.actions };
        } }, n), { features: p({ jump: false, skip: false }, n ? n.features : void 0) }), this.machine), this.devTools.init(this.state);
      }
      fn(this);
    }
  }, e.prototype.toJSON = function() {
...
function xt(e) {
  return p(p({ type: Dt }, e), { toJSON: function() {
    e.onDone, e.onError;
    var t = $t(e, ["onDone", "onError"]);
    return p(p({}, t), { type: Dt, src: yn(e.src) });
  } });
}
var St = "";
var Ut = "#";
...
var mn = function() {
  function e(t, n, i, r) {
    ...
    var o = this, a;
    this.config = t, this._context = i, this.order = -1, this.__xstatenode = true, this.__cache = { events: void 0, relativeValue: /* @__PURE__ */ new Map(), initialStateValue: void 0, initialState: void 0, on: void 0, transitions: void 0, candidates: {}, delayedTransitions: void 0 }, this.idMap = {}, this.tags = [], this.options = Object.assign(gn(), n), this.parent = r == null ? void 0 : r.parent, this.key = this.config.key || (r == null ? void 0 : r.key) || this.config.id || "(machine)", this.machine = this.parent ? this.parent.machine : this, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.delimiter = this.config.delimiter || (this.parent ? this.parent.delimiter : ue), this.id = this.config.id || V([this.machine.key], O(this.path), false).join(this.delimiter), this.version = this.parent ? this.parent.version : this.config.version, this.type = this.config.type || (this.config.parallel ? "parallel" : this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.schema = this.parent ? this.machine.schema : (a = this.config.schema) !== null && a !== void 0 ? a : {}, this.description = this.config.description, this.initial = this.config.initial, this.states = this.config.states ? ct(this.config.states, function(u, h) {
      var f, l = new e(u, {}, void 0, { parent: o, key: h });
    ...
    c(this), this.history = this.config.history === true ? "shallow" : this.config.history || false, this._transient = !!this.config.always || (this.config.on ? Array.isArray(this.config.on) ? this.config.on.some(function(u) {
      var h = u.event;
      return h === St;
    }) : St in this.config.on : false), this.strict = !!this.config.strict, this.onEntry = U(this.config.entry || this.config.onEntry).map(function(u) {
      return dt(u);
      ...
      if (rt(u)) {
        var d = _t(o.id, h);
        return o.machine.options.services = p((f = {}, f[d] = u, f), o.machine.options.services), xt({ src: d, id: d });
      } else if (A(u.src)) {
        var d = u.id || _t(o.id, h);
        return xt(p(p({}, u), { id: d, src: u.src }));
      } else if (rt(u.src) || T(u.src)) {
        var d = u.id || _t(o.id, h);
        return o.machine.options.services = p((l = {}, l[d] = u.src, l), o.machine.options.services), xt(p(p({ id: d }, u), { src: d }));
      } else {
        var y = u.src;
        return xt(p(p({ id: _t(o.id, h) }, u), { src: y }));
      }
  ...
  return e.prototype._init = function() {
    ...
    return new e(this.config, { actions: p(p({}, r), t.actions), activities: p(p({}, o), t.activities), guards: p(p({}, a), t.guards), services: p(p({}, s), t.services), delays: p(p({}, c), t.delays) }, n != null ? n : this.context);
    ...
    var i = function(o, a) {
      ...
      var s = i(o.delay, a);
      return p(p({}, o), { event: s });
    }) : I(Object.keys(n).map(function(o, a) {
      var s = n[o], c = A(s) ? { target: s } : s, u = isNaN(+o) ? o : +o, h = i(u, a);
      return U(c).map(function(f) {
        return p(p({}, f), { event: h, delay: u });
      });
    }));
    return r.map(function(o) {
      var a = o.delay;
      return p(p({}, t.formatTransition(o)), { delay: a });
    });
    ...
    return new F(p(p({}, n), { value: this.resolve(n.value), configuration: i, done: kt(i, this), tags: ie(i), machine: this.machine }));
    ...
    var d = Object.keys(a).map(function(g2) {
      return a[g2];
    }), y = I(d.map(function(g2) {
      return g2.transitions;
    })), v = d.some(function(g2) {
      return g2.transitions.length > 0;
    });
    if (!v) return this.next(n, i);
    var _ = I(Object.keys(a).map(function(g2) {
      return a[g2].configuration;
    }));
    return { transitions: y, exitSet: I(d.map(function(g2) {
      return g2.exitSet;
    })), configuration: _, source: n, actions: I(Object.keys(a).map(function(g2) {
      return a[g2].actions;
    })) };
    ...
    try {
      for (var h = E(this.getCandidates(a)), f = h.next(); !f.done; f = h.next()) {
        var l = f.value, d = l.cond, y = l.in, v = t.context, _ = y ? A(y) && G(y) ? t.matches(ft(this.getStateNodeById(y).path, this.delimiter)) : Xt(ft(y, this.delimiter), Le(this.path.slice(0, -2))(t.value)) : true, g2 = false;
        try {
          g2 = !d || ve(this.machine, d, v, n, t);
        } catch (S) {
...
`).concat(S.message));
        ...
        if (g2 && _) {
          l.target !== void 0 && (c = l.target), s.push.apply(s, V([], O(l.actions), false)), u = l;
          break;
        }
      }
    } catch (S) {
    ...
    if (u) {
      ...
      return { transitions: [u], exitSet: b ? [] : I(c.map(function(S) {
    ...
    var c, u, h, f, l = this, d = a ? ht([], this.getStateNodes(a.value)) : [], y = /* @__PURE__ */ new Set();
    try {
      for (var v = E(Array.from(t).sort(function(x, j) {
        return x.order - j.order;
      })), _ = v.next(); !_.done; _ = v.next()) {
        var g2 = _.value;
        (!lt(d, g2) || lt(i.exitSet, g2) || g2.parent && y.has(g2.parent)) && y.add(g2);
      }
    } catch (x) {
      c = { error: x };
    } finally {
    ...
    try {
      for (var m = E(d), b = m.next(); !b.done; b = m.next()) {
        var g2 = b.value;
        (!lt(t, g2) || lt(i.exitSet, g2.parent)) && i.exitSet.push(g2);
      }
    } catch (x) {
      h = { error: x };
    } finally {
    ...
    var S = Array.from(y).sort(function(x, j) {
      ...
      return { type: "entry", actions: Q(s ? V(V([], O(j), false), O(z), false) : V(V([], O(z), false), O(j), false), l.machine.options.actions) };
      ...
      return { type: "exit", actions: Q(V(V([], O(x.onExit), false), O(x.activities.map(function(j) {
        return We(j);
      })), false), l.machine.options.actions) };
    ...
    var u = this._transition(a.value, a, o) || { transitions: [], configuration: [], exitSet: [], source: a, actions: [] }, h = ht([], this.getStateNodes(a.value)), f = u.configuration.length ? ht(h, u.configuration) : h;
    return u.configuration = V([], O(f), false), this.resolveTransition(u, a, a.context, r, o);
    ...
    var a, s, c, u, h = this;
    o === void 0 && (o = nt);
    var f = t.configuration, l = !n || t.transitions.length > 0, d = l ? t.configuration : n ? n.configuration : [], y = kt(d, this), v = l ? rn2(this.machine, f) : void 0, _ = n ? n.historyValue ? n.historyValue : t.source ? this.machine.historyValue(n.value) : void 0 : void 0, g2 = this.getActions(new Set(d), y, t, i, o, n, r), m = n ? p({}, n.activities) : {};
    try {
      for (var b = E(g2), S = b.next(); !S.done; S = b.next()) {
        var N = S.value;
        try {
    ...
    var w = O(jt(this, n, i, o, g2, r, this.machine.config.predictableActionArguments || this.machine.config.preserveActionOrder), 2), M = w[0], x = w[1], j = O(Me(M, Bt), 2), z = j[0], B = j[1], at = M.filter(function(q2) {
      var K;
      return q2.type === Mt && ((K = q2.activity) === null || K === void 0 ? void 0 : K.type) === Dt;
    }), yt = at.reduce(function(q2, K) {
      return q2[K.activity.id] = Ge(K.activity, h.machine, x, o), q2;
    }, n ? p({}, n.children) : {}), $ = new F({ value: v || n.value, context: x, _event: o, _sessionid: n ? n._sessionid : null, historyValue: v ? _ ? De(_, v) : void 0 : n ? n.historyValue : void 0, history: !v || t.source ? n : void 0, actions: v ? B : [], activities: v ? m : n ? n.activities : {}, events: [], configuration: d, transitions: t.transitions, children: yt, done: y, tags: ie(d), machine: this }), H = i !== x;
    $.changed = o.name === ce || H;
    var W = $.history;
    W && delete W.history;
    var Wt = !y && (this._transient || f.some(function(q2) {
      return q2._transient;
    }));
    if (!l && (!Wt || o.name === St)) return $;
    var J = $;
    if (!y) for (Wt && (J = this.resolveRaisedTransition(J, { type: Oe }, o, r)); z.length; ) {
      var we = z.shift();
    ...
    return this.resolveTransition({ configuration: i, exitSet: [], transitions: [], source: void 0, actions: [] }, void 0, n != null ? n : this.machine.context, void 0);
    ...
    if (Object.keys(this.states).length) return { current: t || this.initialStateValue, states: te(this.states, function(n, i) {
...
`).concat(s.message));
    ...
    }) : true, o = this.machine.options.guards, a = this.resolveTarget(i), s = p(p({}, t), { actions: Q(U(t.actions)), cond: de(t.cond, o), target: a, source: this, internal: r, eventType: t.event, toJSON: function() {
      return p(p({}, s), { target: s.target ? s.target.map(function(c) {
        return "#".concat(c.id);
    ...
    if (!this.config.on) r = [];
      ...
      var o = this.config.on, a = It, s = o[a], c = s === void 0 ? [] : s, u = $t(o, [typeof a == "symbol" ? a : a + ""]);
    ...
    var h = this.config.always ? Z("", this.config.always) : [], f = this.config.onDone ? Z(String(bt(this.id)), this.config.onDone) : [], l = I(this.invoke.map(function(m) {
      var b = [];
      return m.onDone && b.push.apply(b, V([], O(Z(String(Ot(m.id)), m.onDone)), false)), m.onError && b.push.apply(b, V([], O(Z(String(ut(m.id)), m.onError)), false)), b;
    })), d = this.after, y = I(V(V(V(V([], O(f), false), O(l), false), O(r), false), O(h), false).map(function(m) {
...
var et2 = { click: "onClick", mouseenter: "onMouseEnter", mouseleave: "onMouseLeave", complete: "onComplete", after: "onAfter", enter: "onEnter", show: "onShow" };
Object.values(et2);
var bn = Object.keys(et2);
var Tn = class {
  constructor(e, t) {
  ...
  start(e) {
    ...
    if (typeof t > "u") throw g(`invalid state machine id ${e}`);
    ...
    this._service.subscribe((n) => {
      ...
      if (typeof n.changed > "u" || n.changed) {
        ...
        for (let r of n.nextEvents) if (bn.filter((o) => o !== "complete" && o !== "show").includes(r)) {
          let o = t(r);
          this._domListeners.set(r, o), (i = this._domElement) == null || i.addEventListener(r, o, { once: true });
        } else if (r === "complete") {
          let o = t(r);
          this._player.addEventListener(r, o), this._playerListeners.set(r, o);
        } else if (r === "show") {
          let o = t(r);
          this._player.addIntersectionObserver({ callbackOnIntersect: (a) => {
            a > 0 && (a !== 100 && this._onShowPrevValue !== a && o(), this._onShowPrevValue = a);
          }, threshold: [] }), this._domListeners.set("visibilityChange", o);
        }
      }
    });
  }
      ...
      if (s.id = o.descriptor.id, typeof o.descriptor.initial < "u" && (s.initial = o.descriptor.initial), typeof o < "u") {
        ...
        for (let u in c) if (typeof c[u] < "u" && c[u]) {
          ...
          for (let v of l) if (typeof h$1[v] < "u") {
            ...
            if (v === et2.after) {
              let g2 = _;
              y[g2.ms] = { target: (t = _ == null ? void 0 : _.state) != null ? t : "" };
            } else v === et2.enter ? d$1[rn(et2, v)] = { target: (n = _ == null ? void 0 : _.state) != null ? n : "" } : d$1[rn(et2, v)] = { target: (i = _ == null ? void 0 : _.state) != null ? i : "" };
          }
          a[u] = { entry: () => {
            !this._player.getAnimationInstance() || h$1.animationId && h$1.animationId !== this._player.currentAnimationId ? this._player.play(h$1.animationId, () => ({ ...q, ...f })).then(() => {
              this._updatePlaybackSettings(f);
            }).catch((v) => {
              et(`State machine error: ${v.message}`);
            }) : this._updatePlaybackSettings(f);
          }, exit: () => {
            typeof f.segments < "u" && this._player.resetSegments(false), typeof f.playOnScroll < "u" && this._player.stopPlayOnScroll();
          }, on: d$1, after: y, meta: f };
        }
      }
  ...
  _handlePlaySegments(e) {
    if (typeof e.segments == "string") this._player.goToAndPlay(e.segments, true);
    else {
  ...
  _handlePlayOnScroll(e) {
    ...
    } else this._player.playOnScroll({ threshold: t });
  }
  ...
  _requiresDomElement() {
    if (!this._domElement) throw g("Requires a DOM element to attach events.");
  }
};
export {
  Tn as DotLottieStateMachineManager
};
/*! Bundled license information:

@dotlottie/player-component/dist/dotlottie-state-machine-manager-2E7RUGJG-NTQ25VSR.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=dotlottie-state-machine-manager-2E7RUGJG-NTQ25VSR-UQ4KOEWD.js.map
