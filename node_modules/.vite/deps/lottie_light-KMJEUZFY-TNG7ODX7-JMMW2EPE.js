...
// node_modules/@dotlottie/player-component/dist/lottie_light-KMJEUZFY-TNG7ODX7.mjs
var fa = u((xe, We) => {
  typeof navigator < "u" && function(oe, Kt) {
    ...
    var he = /* @__PURE__ */ function() {
        ...
        i || (i = h(function(f) {
          function A() {
            function k(E, F) {
              ...
              for (y = 0; y < n; y += 1) if (d = E[y], "ks" in d && !d.completed) {
                if (d.completed = true, d.hasMask) {
                  ...
                  for (T = z.length, c = 0; c < T; c += 1) if (z[c].pt.k.i) u2(z[c].pt.k);
                  else for (W = z[c].pt.k.length, D = 0; D < W; D += 1) z[c].pt.k[D].s && u2(z[c].pt.k[D].s[0]), z[c].pt.k[D].e && u2(z[c].pt.k[D].e[0]);
                }
            ...
            function l(E) {
              ...
              for (F = d - 1; F >= 0; F -= 1) if (E[F].ty === "sh") if (E[F].ks.k.i) u2(E[F].ks.k);
              else for (n = E[F].ks.k.length, y = 0; y < n; y += 1) E[F].ks.k[y].s && u2(E[F].ks.k[y].s[0]), E[F].ks.k[y].e && u2(E[F].ks.k[y].e[0]);
            ...
            var M = /* @__PURE__ */ function() {
              ...
              function F(y) {
                ...
                else if (y[n].ty === "fl" || y[n].ty === "st") if (y[n].c.k && y[n].c.k[0].i) for (D = y[n].c.k.length, T = 0; T < D; T += 1) y[n].c.k[T].s && (y[n].c.k[T].s[0] /= 255, y[n].c.k[T].s[1] /= 255, y[n].c.k[T].s[2] /= 255, y[n].c.k[T].s[3] /= 255), y[n].c.k[T].e && (y[n].c.k[T].e[0] /= 255, y[n].c.k[T].e[1] /= 255, y[n].c.k[T].e[2] /= 255, y[n].c.k[T].e[3] /= 255);
              ...
              function F(y) {
                var n, c = y.length, T, D;
                for (n = c - 1; n >= 0; n -= 1) if (y[n].ty === "sh") if (y[n].ks.k.i) y[n].ks.k.c = y[n].closed;
          ...
          if (a.dataManager || (a.dataManager = A()), a.assetLoader || (a.assetLoader = /* @__PURE__ */ function() {
            function k(g) {
            ...
            function S(g, p, l, u2) {
              ...
              M.onreadystatechange = function() {
                if (M.readyState === 4) if (M.status === 200) v = k(M), l(v);
                else try {
                  v = k(M), l(v);
                } catch (C) {
                  u2 && u2(C);
      ...
      function o(g, p) {
        ...
        var l, u2 = g.length;
        for (l = 0; l < u2; l += 1) g[l].layers || (!g[l].t || g[l].t === "seq" ? (this.totalImages += 1, this.images.push(this._createImageData(g[l]))) : g[l].t === 3 && (this.totalFootages += 1, this.images.push(this.createFootageData(g[l]))));
      }
      function b(g) {
        this.path = g || "";
      }
...
`), i = {}, r, a = 0, h = 0; h < s.length; h += 1) r = s[h].split(":"), r.length === 2 && (i[r[0]] = r[1].trim(), a += 1);
    ...
    var et = function() {
      ...
      return g.prototype = { get: function(p) {
        ...
        for (var p = this._p[0], l = this._p[2], u2 = 0; u2 < m; ++u2) this._mSampleValues[u2] = A(u2 * o, p, l);
      }, _getTForX: function(p) {
        for (var l = this._p[0], u2 = this._p[2], v = this._mSampleValues, M = 0, C = 1, w = m - 1; C !== w && v[C] <= p; ++C) M += o;
        --C;
    ...
    function Pi() {
      ...
      function s(f, A, x, k, S, g, p, l, u2) {
        if (x === 0 && g === 0 && u2 === 0) return e(f, A, k, S, p, l);
      ...
      var i = /* @__PURE__ */ function() {
        return function(f, A, x, k) {
          ...
          for (l = x.length, g = 0; g < S; g += 1) {
            for (v = g / (S - 1), C = 0, p = 0; p < l; p += 1) u2 = At(1 - v, 3) * f[p] + 3 * At(1 - v, 2) * v * x[p] + 3 * (1 - v) * At(v, 2) * k[p] + At(v, 3) * A[p], w[p] = u2, I[p] !== null && (C += At(w[p] - I[p], 2)), I[p] = w[p];
      ...
      function r(f) {
        ...
        for (p = 0; p < l - 1; p += 1) u2[p] = i(k[p], k[p + 1], S[p], g[p + 1]), v += u2[p].addedLength;
        ...
        return function(A, x, k, S) {
          ...
          if (!f[g]) {
            ...
            for (v = k.length, l = 0; l < p; l += 1) {
              for (N = tt(v), C = l / (p - 1), I = 0, u2 = 0; u2 < v; u2 += 1) M = At(1 - C, 3) * A[u2] + 3 * At(1 - C, 2) * C * (A[u2] + k[u2]) + 3 * (1 - C) * At(C, 2) * (x[u2] + S[u2]) + At(C, 3) * x[u2], N[u2] = M, O !== null && (I += At(N[u2] - O[u2], 2));
      ...
      function o(f, A) {
        ...
        for (var u2 = k[g] > p ? -1 : 1, v = true; v; ) if (k[g] <= p && k[g + 1] > p ? (l = (p - k[g]) / (k[g + 1] - k[g]), v = false) : g += u2, g < 0 || g >= S - 1) {
          if (g === S - 1) return x[g];
          v = false;
        }
    ...
    function xs(t, e) {
      ...
      if (o.to) {
        ...
        if (t >= g || t < p) {
          ...
          for (f = u2.points[v].point.length, P = 0; P < f; P += 1) i[P] = u2.points[v].point[P];
        } else {
          ...
          for (k = e.lastFrame < t && e._lastKeyframeIndex === a ? e._lastPoint : 0, m = true, x = u2.points.length; m; ) {
            if (w += u2.points[k].partialLength, M === 0 || A === 0 || k === u2.points.length - 1) {
              for (f = u2.points[k].point.length, P = 0; P < f; P += 1) i[P] = u2.points[k].point[P];
              break;
            } else if (M >= w && M < w + u2.points[k + 1].partialLength) {
              for (C = (M - w) / u2.points[k + 1].partialLength, f = u2.points[k].point.length, P = 0; P < f; P += 1) i[P] = u2.points[k].point[P] + (u2.points[k + 1].point[P] - u2.points[k].point[P]) * C;
              break;
            }
            k < x - 1 ? k += 1 : m = false;
          }
        ...
        var I, N, O, V, j;
        if (h = o.s.length, l = b.s || o.e, this.sh && o.h !== 1) if (t >= g) i[0] = l[0], i[1] = l[1], i[2] = l[2];
    ...
    function we(t) {
      var e;
      if (this.propType === "unidimensional") e = t * this.mult, Ps(this.v - e) > 1e-5 && (this.v = e, this._mdf = true);
      else for (var s = 0, i = this.v.length; s < i; ) e = t[s] * this.mult, Ps(this.v[s] - e) > 1e-5 && (this.v[s] = e, this._mdf = true), s += 1;
    }
    function Ee() {
    ...
    Mt.prototype.setPathData = function(t, e) {
      ...
      for (m = r; m < h; m += 1) t.setTripleAt(e[a][0], e[a][1], i[a][0], i[a][1], s[a][0], s[a][1], m, false), a -= 1;
      return t;
    ...
    var te = function() {
      ...
      function e(g, p, l) {
        ...
        if (g < E[0].t - this.offsetTime) v = E[0].s[0], C = true, u2 = 0;
        else if (g >= E[E.length - 1].t - this.offsetTime) v = E[E.length - 1].s ? E[E.length - 1].s[0] : E[E.length - 2].e[0], C = true;
        else {
          for (var F = u2, d = E.length - 1, y = true, n, c, T; y && (n = E[F], c = E[F + 1], !(c.t - this.offsetTime > g)); ) F < d - 1 ? F += 1 : y = false;
        ...
        for (N = p._length, O = v.i[0].length, l.lastIndex = u2, w = 0; w < N; w += 1) for (I = 0; I < O; I += 1) j = C ? v.i[w][I] : v.i[w][I] + (M.i[w][I] - v.i[w][I]) * V, p.i[w][I] = j, j = C ? v.o[w][I] : v.o[w][I] + (M.o[w][I] - v.o[w][I]) * V, p.o[w][I] = j, j = C ? v.v[w][I] : v.v[w][I] + (M.v[w][I] - v.v[w][I]) * V, p.v[w][I] = j;
      }
      function s() {
      ...
      function r(g, p) {
        if (g._length !== p._length || g.c !== p.c) return false;
        var l, u2 = g._length;
        for (l = 0; l < u2; l += 1) if (g.v[l][0] !== p.v[l][0] || g.v[l][1] !== p.v[l][1] || g.o[l][0] !== p.o[l][0] || g.o[l][1] !== p.o[l][1] || g.i[l][0] !== p.i[l][0] || g.i[l][1] !== p.i[l][1]) return false;
        return true;
      }
      function a(g) {
      ...
      function A(g, p, l) {
        ...
        } else l === 5 ? u2 = new f(g, p) : l === 6 ? u2 = new _(g, p) : l === 7 && (u2 = new P(g, p));
      ...
      function p(n) {
        for (var c = 0; c < 16; ) {
          if (n.props[c] !== this.props[c]) return false;
          c += 1;
        }
        return true;
      }
    ...
    Y([yt], bt), bt.prototype.initModifierProperties = function(t, e) {
      ...
      if (s === e) for (h = 0; h < m; h += 1) this.shapes[h].localShapeCollection.releaseShapes(), this.shapes[h].shape._mdf = true, this.shapes[h].shape.paths = this.shapes[h].localShapeCollection, this._mdf && (this.shapes[h].pathsData.length = 0);
      else if (s === 1 && e === 0 || s === 0 && e === 1) {
        if (this._mdf) for (h = 0; h < m; h += 1) this.shapes[h].pathsData.length = 0, this.shapes[h].shape._mdf = true;
      } else {
        var x = [], k, S;
      ...
      for (s ? (P = s._length, k = s._length) : (s = nt.newElement(), P = 0, k = 0), x.push(s), a = 0; a < h; a += 1) {
        for (f = i[a].lengths, s.c = r[a].c, o = r[a].c ? f.length : f.length + 1, m = 1; m < o; m += 1) if (_ = f[m - 1], b + _.addedLength < e.s) b += _.addedLength, s.c = false;
        else if (b > e.e) {
          s.c = false;
          break;
        } else e.s <= b && e.e >= b + _.addedLength ? (this.addSegment(r[a].v[m - 1], r[a].o[m - 1], r[a].i[m], r[a].v[m], s, P, S), S = false) : (A = Pt.getNewSegment(r[a].v[m - 1], r[a].v[m], r[a].o[m - 1], r[a].i[m], (e.s - b) / _.addedLength, (e.e - b) / _.addedLength, f[m - 1]), this.addSegmentFromArray(A, s, P, S), S = false, s.c = false), b += _.addedLength, P += 1;
        if (r[a].c && f.length) {
          if (_ = f[m - 1], b <= e.e) {
    ...
    Y([yt], ue), ue.prototype.initModifierProperties = function(t, e) {
      ...
      if (h !== 0) {
        var m, o;
        for (s = 0; s < i; s += 1) {
          if (m = this.shapes[s], o = m.localShapeCollection, !(!m.shape._mdf && !this._mdf && !t)) for (o.releaseShapes(), m.shape._mdf = true, e = m.shape.paths.shapes, a = m.shape.paths._length, r = 0; r < a; r += 1) o.addShape(this.processPath(e[r], h));
    ...
    var Ge = function() {
        ...
        if (this.elem.globalData.frameId !== this.frameId) {
          if (this._isDirty && (this.precalculateMatrix(), this._isDirty = false), this.iterateDynamicProperties(), this._mdf || o) {
            ...
            if (this.v.cloneFromProps(this.pre.props), this.appliedTransformations < 1 && this.v.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]), this.appliedTransformations < 2 && this.v.scale(this.s.v[0], this.s.v[1], this.s.v[2]), this.sk && this.appliedTransformations < 3 && this.v.skewFromAxis(-this.sk.v, this.sa.v), this.r && this.appliedTransformations < 4 ? this.v.rotate(-this.r.v) : !this.r && this.appliedTransformations < 4 && this.v.rotateZ(-this.rz.v).rotateY(this.ry.v).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(this.or.v[0]), this.autoOriented) {
              var _, P;
              if (b = this.elem.globalData.frameRate, this.p && this.p.keyframes && this.p.getValueAtTime) this.p._caching.lastFrame + this.p.offsetTime <= this.p.keyframes[0].t ? (_ = this.p.getValueAtTime((this.p.keyframes[0].t + 0.01) / b, 0), P = this.p.getValueAtTime(this.p.keyframes[0].t / b, 0)) : this.p._caching.lastFrame + this.p.offsetTime >= this.p.keyframes[this.p.keyframes.length - 1].t ? (_ = this.p.getValueAtTime(this.p.keyframes[this.p.keyframes.length - 1].t / b, 0), P = this.p.getValueAtTime((this.p.keyframes[this.p.keyframes.length - 1].t - 0.05) / b, 0)) : (_ = this.p.pv, P = this.p.getValueAtTime((this.p._caching.lastFrame + this.p.offsetTime - 0.01) / b, this.p.offsetTime));
      ...
      function h(o, b, _) {
        ...
        } else this.r = L.getProp(o, b.r || { k: 0 }, 0, H, this);
    ...
    Y([yt], xt), xt.prototype.initModifierProperties = function(t, e) {
      this.getValue = this.processKeys, this.c = L.getProp(t, e.c, 0, null, this), this.o = L.getProp(t, e.o, 0, null, this), this.tr = Ge.getTransformProperty(t, e.tr, this), this.so = L.getProp(t, e.tr.so, 0, 0.01, this), this.eo = L.getProp(t, e.tr.eo, 0, 0.01, this), this.data = e, this.dynamicProperties.length || this.getValue(true), this._isAnimated = !!this.dynamicProperties.length, this.pMatrix = new ot(), this.rMatrix = new ot(), this.sMatrix = new ot(), this.tMatrix = new ot(), this.matrix = new ot();
      ...
      if (this._mdf || t) {
        ...
        var p = 0;
        if (f > 0) {
          for (; p < x; ) this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, false), p += 1;
          A && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, A, false), p += A);
        } else if (f < 0) {
          for (; p > x; ) this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, true), p -= 1;
        ...
        for (var l, u2; a; ) {
          if (e = this.elemsData[i].it, s = e[e.length - 1].transform.mProps.v.props, u2 = s.length, e[e.length - 1].transform.mProps._mdf = true, e[e.length - 1].transform.op._mdf = true, e[e.length - 1].transform.op.v = this._currentCopies === 1 ? this.so.v : this.so.v + (this.eo.v - this.so.v) * (i / (this._currentCopies - 1)), p !== 0) {
            for ((i !== 0 && r === 1 || i !== this._currentCopies - 1 && r === -1) && this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, false), this.matrix.transform(S[0], S[1], S[2], S[3], S[4], S[5], S[6], S[7], S[8], S[9], S[10], S[11], S[12], S[13], S[14], S[15]), this.matrix.transform(g[0], g[1], g[2], g[3], g[4], g[5], g[6], g[7], g[8], g[9], g[10], g[11], g[12], g[13], g[14], g[15]), this.matrix.transform(k[0], k[1], k[2], k[3], k[4], k[5], k[6], k[7], k[8], k[9], k[10], k[11], k[12], k[13], k[14], k[15]), l = 0; l < u2; l += 1) s[l] = this.matrix.props[l];
            this.matrix.reset();
          } else for (this.matrix.reset(), l = 0; l < u2; l += 1) s[l] = this.matrix.props[l];
          p += 1, a -= 1, i += r;
        }
    ...
    G.prototype.point = function(t) {
      ...
      return [new G(this.points[0], e, r, h, true), new G(h, a, i, this.points[3], true)];
    };
    function Ls(t, e) {
    ...
    G.prototype.intersections = function(t, e, s) {
      ...
      var s = (e + 1) % t.length();
      return new G(t.v[e], t.o[e], t.i[s], t.v[s], true);
    }, G.shapeSegmentInverted = function(t, e) {
      var s = (e + 1) % t.length();
      return new G(t.v[s], t.i[s], t.o[e], t.v[e], true);
    };
    function Qe(t, e) {
    ...
    ce.prototype.processPath = function(t, e, s, i) {
      ...
      if (h !== 0) {
        var b, _;
        for (s = 0; s < i; s += 1) {
          if (b = this.shapes[s], _ = b.localShapeCollection, !(!b.shape._mdf && !this._mdf && !t)) for (_.releaseShapes(), b.shape._mdf = true, e = b.shape.paths.shapes, a = b.shape.paths._length, r = 0; r < a; r += 1) _.addShape(this.processPath(e[r], h, m, o));
    ...
    Y([yt], ge), ge.prototype.initModifierProperties = function(t, e) {
      ...
      if (h !== 0) {
        var b, _;
        for (s = 0; s < i; s += 1) {
          if (b = this.shapes[s], _ = b.localShapeCollection, !(!b.shape._mdf && !this._mdf && !t)) for (_.releaseShapes(), b.shape._mdf = true, e = b.shape.paths.shapes, a = b.shape.paths._length, r = 0; r < a; r += 1) _.addShape(this.processPath(e[r], h, o, m));
          b.shape.paths = b.localShapeCollection;
        }
      }
      this.dynamicProperties.length || (this._mdf = false);
    ...
    var Gt = function() {
      ...
      function S(d, y) {
        ...
        for (c = 0; c < T; c += 1) {
          var W = true, z, J;
          if (n[c].loaded = false, n[c].monoCase = A(n[c].fFamily, "monospace"), n[c].sansCase = A(n[c].fFamily, "sans-serif"), !n[c].fPath) n[c].loaded = true, D -= 1;
            ...
            for (z = document.querySelectorAll('link[f-forigin="g"], link[f-origin="1"]'), J = 0; J < z.length; J += 1) z[J].href.indexOf(n[c].fPath) !== -1 && (W = false);
            if (W) {
              var $ = Lt("link");
            ...
            for (z = document.querySelectorAll('script[f-forigin="t"], script[f-origin="2"]'), J = 0; J < z.length; J += 1) n[c].fPath === z[J].src && (W = false);
            if (W) {
              var K = Lt("link");
      ...
      function g(d) {
        if (d) {
          ...
          for (y = 0; y < n; y += 1) {
            for (c = 0, D = false; c < T; ) this.chars[c].style === d[y].style && this.chars[c].fFamily === d[y].fFamily && this.chars[c].ch === d[y].ch && (D = true), c += 1;
      ...
      function V(d, y) {
        ...
        var c = 0;
        for (y += 2; c < 5; ) {
          if (n = v(d.substr(y, 2)), n < a || n > h) return false;
          c += 1, y += 2;
        }
    ...
    ht.prototype.checkLayers = function(t) {
      ...
      for (var i = this.elements, r = this.layers, a = 0, h = r.length; a < h; ) r[a].ind == e && (!i[a] || i[a] === true ? (this.buildItem(a), this.addPendingElement(t)) : (s.push(i[a]), i[a].setAsParent(), r[a].parent !== void 0 ? this.buildElementParenting(t, r[a].parent, s) : t.setHierarchy(s))), a += 1;
    ...
    ae.prototype = { initTransform: function() {
      var t = new ot();
      this.finalTransform = { mProp: this.data.ks ? Ge.getTransformProperty(this, this.data.ks, this) : { o: 0 }, _matMdf: false, _localMatMdf: false, _opMdf: false, mat: t, localMat: t, localOpacity: 1 }, this.data.ao && (this.finalTransform.mProp.autoOriented = true), this.data.ty;
    ...
    function Ht(t, e, s) {
      ...
      for (r = 0; r < a; r += 1) if ((m[r].mode !== "a" && m[r].mode !== "n" || m[r].inv || m[r].o.k !== 100 || m[r].o.x) && (g = "mask", p = "mask"), (m[r].mode === "s" || m[r].mode === "i") && o === 0 ? (A = q("rect"), A.setAttribute("fill", "#ffffff"), A.setAttribute("width", this.element.comp.data.w || 0), A.setAttribute("height", this.element.comp.data.h || 0), b.push(A)) : A = null, h = q("path"), m[r].mode === "n") this.viewData[r] = { op: L.getProp(this.element, m[r].o, 0, 0.01, this.element), prop: Ie.getShapeProp(this.element, m[r], 3), elem: h, lastPath: "" }, i.appendChild(h);
      else {
        ...
        if (m[r].x.k !== 0 ? (g = "mask", p = "mask", S = L.getProp(this.element, m[r].x, 0, null, this.element), l = pt(), x = q("filter"), x.setAttribute("id", l), k = q("feMorphology"), k.setAttribute("operator", "erode"), k.setAttribute("in", "SourceGraphic"), k.setAttribute("radius", "0"), x.appendChild(k), i.appendChild(x), h.setAttribute("stroke", m[r].mode === "s" ? "#000000" : "#ffffff")) : (k = null, S = null), this.storedData[r] = { elem: h, x: S, expan: k, lastPath: "", lastOperator: "", filterId: l, lastRadius: 0 }, m[r].mode === "i") {
          P = b.length;
          var u2 = q("g");
          for (_ = 0; _ < P; _ += 1) u2.appendChild(b[_]);
          var v = q("mask");
    ...
    var Zs = { 1: "butt", 2: "round", 3: "square" }, Gs = { 1: "miter", 2: "round", 3: "bevel" };
    function Hs(t, e, s) {
    ...
    function Ne(t, e, s, i) {
      ...
      for (r = 0; r < a; r += 1) h = L.getProp(t, e[r].v, 0, 0, this), this.k = h.k || this.k, this.dataProps[r] = { n: e[r].n, p: h };
    ...
    Y([Ot, ae, be, Us, re, Nt, _e], Q), Q.prototype.initSecondaryElement = function() {
      ...
      for (i = 0; i < r; i += 1) {
        for (a = this.stylesList[i], m = false, h.length = 0, t = 0; t < e; t += 1) s = this.shapes[t], s.styles.indexOf(a) !== -1 && (h.push(s), m = s._isAnimated || m);
      ...
      for (o = b; o >= 0; o -= 1) {
        if (S = this.searchProcessedElement(t[o]), S ? e[o] = s[S - 1] : t[o]._render = h, t[o].ty === "fl" || t[o].ty === "st" || t[o].ty === "gf" || t[o].ty === "gs" || t[o].ty === "no") S ? e[o].style.closed = false : e[o] = this.createStyleElement(t[o], r), t[o]._render && e[o].style.pElem.parentNode !== i && i.appendChild(e[o].style.pElem), f.push(e[o].style);
        else if (t[o].ty === "gr") {
        ...
        } else t[o].ty === "tr" ? (S || (e[o] = this.createTransformElement(t[o], i)), x = e[o].transform, m.push(x)) : t[o].ty === "sh" || t[o].ty === "rc" || t[o].ty === "el" || t[o].ty === "sr" ? (S || (e[o] = this.createShapeElement(t[o], m, r)), this.setElementStyles(e[o])) : t[o].ty === "tm" || t[o].ty === "rd" || t[o].ty === "ms" || t[o].ty === "pb" || t[o].ty === "zz" || t[o].ty === "op" ? (S ? (k = e[o], k.closed = false) : (k = zt.getModifier(t[o].ty), k.init(this, t[o]), e[o] = k, this.shapeModifiers.push(k)), A.push(k)) : t[o].ty === "rp" && (S ? (k = e[o], k.closed = true) : (k = zt.getModifier(t[o].ty), e[o] = k, k.init(this, t, o, e), this.shapeModifiers.push(k), h = false), A.push(k));
        this.addProcessedElement(t[o], o + 1);
      }
      for (b = f.length, o = 0; o < b; o += 1) f[o].closed = true;
      for (b = A.length, o = 0; o < b; o += 1) A[o].closed = true;
    ...
    lt.prototype.defaultBoxWidth = [0, 0], lt.prototype.copyData = function(t, e) {
      ...
      for (var e = [], s = 0, i = t.length, r, a, h = false, m = false, o = ""; s < i; ) h = m, m = false, r = t.charCodeAt(s), o = t.charAt(s), Gt.isCombinedCharacter(r) ? h = true : r >= 55296 && r <= 56319 ? Gt.isRegionalFlag(t, s) ? o = t.substr(s, 14) : (a = t.charCodeAt(s + 1), a >= 56320 && a <= 57343 && (Gt.isModifier(r, a) ? (o = t.substr(s, 2), h = true) : Gt.isFlagEmoji(t.substr(s, 4)) ? o = t.substr(s, 4) : o = t.substr(s, 2))) : r > 56319 ? (a = t.charCodeAt(s + 1), Gt.isVariationSelector(r) && (h = true)) : Gt.isZeroWidthJoiner(r) && (h = true, m = true), h ? (e[e.length - 1] += o, h = false) : e.push(o), s += o.length;
      return e;
      ...
      if (t.sz) for (var w = true, I = t.sz[0], N = t.sz[1], O, V; w; ) {
        V = this.buildFinalText(t.t), O = 0, x = 0, a = V.length, M = t.tr / 1e3 * t.finalSize;
        var j = -1;
        for (r = 0; r < a; r += 1) C = V[r].charCodeAt(0), h = false, V[r] === " " ? j = r : (C === 13 || C === 3) && (x = 0, h = true, O += t.finalLineHeight || t.finalSize * 1.2), e.chars ? (l = e.getCharData(V[r], p.fStyle, p.fFamily), u2 = h ? 0 : l.w * t.finalSize / 100) : u2 = e.measureText(V[r], t.f, t.finalSize), x + u2 > I && V[r] !== " " ? (j === -1 ? a += 1 : r = j, O += t.finalLineHeight || t.finalSize * 1.2, V.splice(r, j === r ? 1 : 0, "\r"), j = -1, x = 0) : (x += u2, x += M);
      ...
      x = -M, u2 = 0;
      var E = 0, F;
      for (r = 0; r < a; r += 1) if (h = false, F = t.finalText[r], C = F.charCodeAt(0), C === 13 || C === 3 ? (E = 0, A.push(x), k = x > k ? x : k, x = -2 * M, o = "", h = true, f += 1) : o = F, e.chars ? (l = e.getCharData(F, p.fStyle, e.getFontByName(t.f).fFamily), u2 = h ? 0 : l.w * t.finalSize / 100) : u2 = e.measureText(o, t.f, t.finalSize), F === " " ? E += u2 + M : (x += u2 + M + E, E = 0), i.push({ l: u2, an: u2, add: _, n: h, anIndexes: [], val: o, line: f, animatorJustifyOffset: 0 }), b == 2) {
        if (_ += u2, o === "" || o === " " || r === a - 1) {
          for ((o === "" || o === " ") && (_ -= u2); P <= r; ) i[P].an = _, i[P].ind = m, i[P].extra = u2, P += 1;
          m += 1, _ = 0;
        }
      } else if (b == 3) {
        if (_ += u2, o === "" || r === a - 1) {
          for (o === "" && (_ -= u2); P <= r; ) i[P].an = _, i[P].ind = m, i[P].extra = u2, P += 1;
          _ = 0, m += 1;
        }
      ...
      var c, T, D = [];
      for (S = 0; S < g; S += 1) {
        for (y = d[S], y.a.sc && (t.strokeColorAnim = true), y.a.sw && (t.strokeWidthAnim = true), (y.a.fc || y.a.fh || y.a.fs || y.a.fb) && (t.fillColorAnim = true), T = 0, c = y.s.b, r = 0; r < a; r += 1) n = i[r], n.anIndexes[S] = T, (c == 1 && n.val !== "" || c == 2 && n.val !== "" && n.val !== " " || c == 3 && (n.n || n.val == " " || r == a - 1) || c == 4 && (n.n || r == a - 1)) && (y.s.rn === 1 && D.push(T), T += 1);
    ...
    var ha = function() {
      ...
      i.prototype = { getMult: function(a) {
        ...
        if (x === 2) A === f ? P = a >= A ? 1 : 0 : P = t(0, e(0.5 / (A - f) + (a - f) / (A - f), 1)), P = _(P);
        else if (x === 3) A === f ? P = a >= A ? 0 : 1 : P = 1 - t(0, e(0.5 / (A - f) + (a - f) / (A - f), 1)), P = _(P);
        else if (x === 4) A === f ? P = 0 : (P = t(0, e(0.5 / (A - f) + (a - f) / (A - f), 1)), P < 0.5 ? P *= 2 : P = 1 - 2 * (P - 0.5)), P = _(P);
        else if (x === 5) {
          if (A === f) P = 0;
          else {
            var k = A - f;
          ...
          P = _(P);
        } else x === 6 ? (A === f ? P = 0 : (a = e(t(0, a + 0.5 - f), A - f), P = (1 + Math.cos(Math.PI + Math.PI * 2 * a / (A - f))) / 2), P = _(P)) : (a >= s(f) && (a - f < 0 ? P = t(0, e(e(A, 1) - (f - a), 1)) : P = t(0, e(A - a, 1))), P = _(P));
        if (this.sm.v !== 100) {
    ...
    Qt.prototype.searchProperties = function() {
      ...
      if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
        ...
        if (this._hasMaskedPath) {
          ...
          if (A = this._pathData.pi, x = this._pathData.f.v, l = 0, p = 1, S = 0, g = true, M = A.segments, x < 0 && O.v.c) for (A.tLength < Math.abs(x) && (x = -Math.abs(x) % A.tLength), l = M.length - 1, v = M[l].points, p = v.length - 1; x < 0; ) x += v[p].partialLength, p -= 1, p < 0 && (l -= 1, v = M[l].points, p = v.length - 1);
        ...
        for (_ = 0; _ < P; _ += 1) {
          if (a.reset(), mt = 1, f[_].n) o = 0, b += t.yOffset, b += F ? 1 : 0, x = $, F = false, this._hasMaskedPath && (l = K, p = ut, v = M[l].points, u2 = v[p - 1], k = v[p], C = k.partialLength, S = 0), St = "", Et = "", wt = "", It = "", Ft = this.defaultPropsArray;
          else {
            if (this._hasMaskedPath) {
              if (Dt !== f[_].line) {
                switch (t.j) {
              ...
              for (g = true, this._pathData.a.v && (x = f[0].an * 0.5 + (w - this._pathData.f.v - f[0].an * 0.5 - f[f.length - 1].an * 0.5) * W / (P - 1), x += this._pathData.f.v); g; ) S + C >= x + kt || !v ? (I = (x + kt - S) / k.partialLength, J = u2.point[0] + (k.point[0] - u2.point[0]) * I, X = u2.point[1] + (k.point[1] - u2.point[1]) * I, a.translate(-s[0] * f[_].an * 5e-3, -(s[1] * E) * 0.01), g = false) : v && (S += k.partialLength, p += 1, p >= v.length && (p = 0, l += 1, M[l] ? v = M[l].points : O.v.c ? (p = 0, l = 0, v = M[l].points) : (S -= k.partialLength, v = null)), v && (u2 = k, k = v[p], C = k.partialLength));
              z = f[_].an / 2 - f[_].add, a.translate(-z, 0, 0);
            } else z = f[_].an / 2 - f[_].add, a.translate(-z, 0, 0), a.translate(-s[0] * f[_].an * 5e-3, -s[1] * E * 0.01, 0);
    ...
    vt.prototype.initElement = function(t, e, s) {
      ...
      for (s = 0; s < i; s += 1) e[s].ty === "sh" && (r = e[s].ks.k, a += si(r, r.i.length, true, t));
      return a;
    ...
    Y([Ot, ae, be, re, Nt, _e, vt], Tt), Tt.prototype.createContent = function() {
      ...
      if (P && !m && !s.sz) {
        ...
        for (e = p.length, A = s.ps ? s.ps[1] + s.ascent : 0, t = 0; t < e; t += 1) o = this.textSpans[t].span || q("tspan"), o.textContent = p[t], o.setAttribute("x", 0), o.setAttribute("y", A), o.style.display = "inherit", S.appendChild(o), this.textSpans[t] || (this.textSpans[t] = { span: null, glyph: null }), this.textSpans[t].span = o, A += s.finalLineHeight;
        ...
        for (t = 0; t < e; t += 1) {
          ...
          if (b.reset(), P && (h[t].n && (f = -k, A += s.yOffset, A += x ? 1 : 0, x = false), this.applyTextPropertiesToMatrix(s, b, h[t].line, f, A), f += h[t].l || 0, f += k), m) {
            ...
            var M;
            if (u2.t === 1) M = new Pe(u2.data, this.globalData, this);
            else {
              var C = pa;
...
@dotlottie/player-component/dist/lottie_light-KMJEUZFY-TNG7ODX7.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=lottie_light-KMJEUZFY-TNG7ODX7-JMMW2EPE.js.map
